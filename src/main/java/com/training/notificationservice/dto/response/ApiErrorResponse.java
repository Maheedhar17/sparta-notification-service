...
/**
 * Structured error body returned by every endpoint on failure, produced
 * centrally by {@code GlobalExceptionHandler} so callers always see the
 * same shape regardless of which exception was thrown.
 */
